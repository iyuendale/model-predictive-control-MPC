...
for NN = 1:size(N, 2)
	...
	subplot 211, legend('Set point', ['N = ', num2str(N(NN))], 'DLQR'), title 'output'
	subplot 212, legend('Set point', ['N = ', num2str(N(NN))], 'DLQR'), title 'optimal control'
	
	disp(['squared error for N = ', num2str(N(NN)), ' is: ', num2str(sum)])
end